...
const triggerBase =
  "box-border inline-flex h-10 w-full min-w-0 shrink-0 items-center justify-between gap-2 rounded-xl border border-zinc-700 bg-zinc-950 px-3 py-0 text-sm font-medium leading-none text-zinc-100 outline-none transition hover:border-zinc-600 focus:border-cyan-500/50 focus:ring-2 focus:ring-cyan-500/20 disabled:cursor-not-allowed disabled:opacity-50 data-[placeholder]:text-zinc-500";
