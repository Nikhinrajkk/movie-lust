...
select
  ...
  'https://image.tmdb.org/t/p/w500/f496cm9enu0Dm8qG12MtDOS6B3.jpg',
  '1994-09-22'::date,
  '2004-05-06'::date,
  1994,
  2004,
  array['comedy', 'feelgood', 'romance']::text[],
  'classic',
  8.8::numeric,
  'Catalogue: user curated series batch (2026-06-11).',
  10,
  ...
  'pending',
  null::uuid
where not exists (select 1 from public.series s where s.title = 'Friends');
